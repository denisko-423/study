...
Исправленный по этому методу стенд находится в папке `dns_problems_solution_1`. Команды semanage и restorecon с параметрами прописаны в playbook Ansible, остальные файлы стенда остались без изменений.
